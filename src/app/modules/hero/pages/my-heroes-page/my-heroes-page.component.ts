...
import { getMe } from 'src/app/modules/user/store/user.actions';
import { Observable } from 'rxjs';
import { selectgetMe } from 'src/app/modules/user/store/user.selectors';
...
export class MyHeroesPageComponent implements OnInit {
  ...
  constructor(
    ...
    this.onChanges();
    this.getMe$ = store.pipe(select(selectgetMe));
    this.subscriptions();
  }
