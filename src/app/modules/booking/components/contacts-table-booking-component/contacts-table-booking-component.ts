...
@Component({
  selector: 'app-contacts-table-booking-component',
  templateUrl: './contacts-table-booking-component.html',
  styleUrls: ['./contacts-table-booking-component.scss'],
})
export class ContactsTableBookingComponent implements OnInit, OnDestroy {
  isMenuVisible = false;
